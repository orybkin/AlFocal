...
if isempty(DEPPAGRunning) || (DEPPAGRunning ~= true)
    ...
    ps.quietMode      = false;    % don't show plots and don't print lots of stuff.
    % When run on cluster stuff gets printed into the log leading to 3MB logs.
...
if ps.Prepare
    ...
    fn = fullfile(pc.dataPath,ps.Data, 'features_F.mat');
    ...
    fn = fullfile(pc.dataPath,ps.Data, 'correspondences_F.mat');
