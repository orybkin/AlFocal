...
noise=10*ones(size(corresp));
%noise=0;

pop_size=2; % number of points that will be on scatter plot
...
for i=1:n
    ...
    for m=1:size(methods,2)
        [stat_temp, data_temp]=bougnoux_scatter(file,corresp(i),pop_size,methods{m},noise(i),plot_data);
